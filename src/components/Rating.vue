<template>
  <div class="rating">
    <div class="start" v-if="rating.average != 0">
      <span class="start-full" v-for="n in full"></span>
      <span class="start-half" v-for="n in half"></span>
      <span class="start-gray" v-for="n in gray"></span>
